document.addEventListener("DOMContentLoaded", function() {
  ...
  document.getElementById('alternar-tema').addEventListener('click', function () {
    ...
    if (document.body.classList.contains('tema-claro')) {
      ...
      document.getElementById('profile-image').src = 'https://marcelnieridev.github.io/assets/images/tema_claro.png';
      document.querySelector('.sobre img').src = 'https://marcelnieridev.github.io/assets/images/perfil-claro.png';
      ...
      document.getElementById('profile-image').src = 'https://marcelnieridev.github.io/assets/images/Acenando_perfil.png';
      document.querySelector('.sobre img').src = 'https://marcelnieridev.github.io/assets/images/perfil.png';
